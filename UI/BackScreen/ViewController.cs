...
namespace DevTools.Humankind.GUITools.UI
{
    ...
    {
        public static event Action ViewModeChange;
        ...
        private static void OnUIStateChange(UIState newState)
        {
            if (!Modding.Humankind.DevTools.DevTools.QuietMode)
                Loggr.Log("IN OnUIStateChange(newState = " + newState.ToString() + ")",
        ...
        private static void SetViewMode(ViewModeType value)
        {
            ...
            UpdateGloballyDisabled();
            Action viewModeChange = ViewModeChange;
            if (viewModeChange == null)
                return;
            viewModeChange();
        }
